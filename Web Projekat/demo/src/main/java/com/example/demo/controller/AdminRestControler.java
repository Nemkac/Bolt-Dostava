...
public class AdminRestControler {
    ...
    public ResponseEntity<String> kreirajDostavljaca(DostavljacDto dostavljacDto, HttpSession sesija){
        ...
        Dostavljac dostavljac = new Dostavljac(dostavljacDto.getKorisnickoIme(), dostavljacDto.getLozinka(),
                dostavljacDto.getIme(), dostavljacDto.getPrezime(), dostavljacDto.getPol(), dostavljacDto.getDatum());
