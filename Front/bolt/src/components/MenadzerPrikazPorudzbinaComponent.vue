    ...
    <table class="table">
      ...
      <tr v-for="porudzbina in porudzbine" v-bind:key="porudzbina.id">
        ...
        <td v-if="porudzbina.status=='OBRADA'">
          <button v-on:click="this.promeniStatus(porudzbina.id)" className="btn btn-primary" class="btn">Status: "U PRIPREMI" </button>
        </td>
        <td v-if="porudzbina.status=='UPRIPREMI'">
          <button v-on:click="this.promeniStatusUCekaDostavljaca(porudzbina.id)" className="btn btn-primary" class="btn">Status: "CEKA DOSTAVLJACA" </button>
        </td>
      </tr>
      </tbody>
    </table>
    <button v-on:click="this.otvoriProfilRestorana()" className="btn btn-primary" class="btnRestoran"> Prikazi restoran</button>
  </div>
...
export default {
  ...
  methods: {
    ...
    otvoriProfilRestorana(){
      this.$router.push("/menadzerProfil");
    }
  },
  created() {
