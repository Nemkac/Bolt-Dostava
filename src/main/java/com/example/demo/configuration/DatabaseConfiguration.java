...
public class DatabaseConfiguration {
    ...
    public boolean instantiate(){
        ...
        Artikal artikal = new Artikal("Margarita", 800L, 1F, "Prava italijanska pica", TipArtikla.JELO);
        Artikal artikal1 = new Artikal("Kapricoza", 950L, 1F, "Prava italijanska pica", TipArtikla.JELO);
        Artikal artikal2 = new Artikal("Sremica", 900L, 1F, "Prava italijanska pica", TipArtikla.JELO);
        Artikal artikal3 = new Artikal("Salami", 600L, 1F, "Prava italijanska pica", TipArtikla.JELO);
        Artikal artikal4 = new Artikal("Italiana", 650L, 1F, "Prava italijanska pica", TipArtikla.JELO);
        Artikal pice = new Artikal("Cappuccino", 150L, 1F, "Prava italijanska kafa", TipArtikla.PICE);
